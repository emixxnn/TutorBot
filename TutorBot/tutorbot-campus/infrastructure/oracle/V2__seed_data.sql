...
MERGE INTO SKILLS tgt USING (SELECT 1 AS ID, 'Frontend'                AS NAME, 1 AS ACTIVE FROM DUAL) src ON (tgt.ID = src.ID)
WHEN MATCHED THEN UPDATE SET tgt.NAME = src.NAME, tgt.ACTIVE = src.ACTIVE
WHEN NOT MATCHED THEN INSERT (ID, NAME, ACTIVE) VALUES (src.ID, src.NAME, src.ACTIVE);

MERGE INTO SKILLS tgt USING (SELECT 2 AS ID, 'Estructuras de Datos'    AS NAME, 1 AS ACTIVE FROM DUAL) src ON (tgt.ID = src.ID)
WHEN MATCHED THEN UPDATE SET tgt.NAME = src.NAME, tgt.ACTIVE = src.ACTIVE
WHEN NOT MATCHED THEN INSERT (ID, NAME, ACTIVE) VALUES (src.ID, src.NAME, src.ACTIVE);

MERGE INTO SKILLS tgt USING (SELECT 3 AS ID, 'Bases de Datos'          AS NAME, 1 AS ACTIVE FROM DUAL) src ON (tgt.ID = src.ID)
WHEN MATCHED THEN UPDATE SET tgt.NAME = src.NAME, tgt.ACTIVE = src.ACTIVE
WHEN NOT MATCHED THEN INSERT (ID, NAME, ACTIVE) VALUES (src.ID, src.NAME, src.ACTIVE);

MERGE INTO SKILLS tgt USING (SELECT 4 AS ID, 'Inteligencia Artificial' AS NAME, 1 AS ACTIVE FROM DUAL) src ON (tgt.ID = src.ID)
WHEN MATCHED THEN UPDATE SET tgt.NAME = src.NAME, tgt.ACTIVE = src.ACTIVE
WHEN NOT MATCHED THEN INSERT (ID, NAME, ACTIVE) VALUES (src.ID, src.NAME, src.ACTIVE);

MERGE INTO SKILLS tgt USING (SELECT 5 AS ID, 'Redes'                   AS NAME, 0 AS ACTIVE FROM DUAL) src ON (tgt.ID = src.ID)
WHEN MATCHED THEN UPDATE SET tgt.NAME = src.NAME, tgt.ACTIVE = src.ACTIVE
WHEN NOT MATCHED THEN INSERT (ID, NAME, ACTIVE) VALUES (src.ID, src.NAME, src.ACTIVE);

MERGE INTO SKILLS tgt USING (SELECT 6 AS ID, 'Ingeniería de Software'  AS NAME, 1 AS ACTIVE FROM DUAL) src ON (tgt.ID = src.ID)
WHEN MATCHED THEN UPDATE SET tgt.NAME = src.NAME, tgt.ACTIVE = src.ACTIVE
WHEN NOT MATCHED THEN INSERT (ID, NAME, ACTIVE) VALUES (src.ID, src.NAME, src.ACTIVE);

-- =====================  CATALOGUE — TOPICS  =================

MERGE INTO TOPICS tgt USING (SELECT  1 AS ID, 'HTML y CSS'               AS NAME, 1 AS CID, 1 AS ACTIVE, 1 AS SID FROM DUAL) src ON (tgt.ID=src.ID)
WHEN MATCHED THEN UPDATE SET tgt.NAME = src.NAME, tgt.COURSE_ID = src.CID, tgt.ACTIVE = src.ACTIVE, tgt.SKILL_ID = src.SID
WHEN NOT MATCHED THEN INSERT(ID,NAME,COURSE_ID,ACTIVE,SKILL_ID) VALUES(src.ID,src.NAME,src.CID,src.ACTIVE,src.SID);
MERGE INTO TOPICS tgt USING (SELECT  2 AS ID, 'JavaScript'               AS NAME, 1 AS CID, 1 AS ACTIVE, 1 AS SID FROM DUAL) src ON (tgt.ID=src.ID)
WHEN MATCHED THEN UPDATE SET tgt.NAME = src.NAME, tgt.COURSE_ID = src.CID, tgt.ACTIVE = src.ACTIVE, tgt.SKILL_ID = src.SID
WHEN NOT MATCHED THEN INSERT(ID,NAME,COURSE_ID,ACTIVE,SKILL_ID) VALUES(src.ID,src.NAME,src.CID,src.ACTIVE,src.SID);
MERGE INTO TOPICS tgt USING (SELECT  3 AS ID, 'Spring Boot'              AS NAME, 1 AS CID, 1 AS ACTIVE, 1 AS SID FROM DUAL) src ON (tgt.ID=src.ID)
WHEN MATCHED THEN UPDATE SET tgt.NAME = src.NAME, tgt.COURSE_ID = src.CID, tgt.ACTIVE = src.ACTIVE, tgt.SKILL_ID = src.SID
WHEN NOT MATCHED THEN INSERT(ID,NAME,COURSE_ID,ACTIVE,SKILL_ID) VALUES(src.ID,src.NAME,src.CID,src.ACTIVE,src.SID);
MERGE INTO TOPICS tgt USING (SELECT  4 AS ID, 'Árboles Binarios'         AS NAME, 2 AS CID, 1 AS ACTIVE, 2 AS SID FROM DUAL) src ON (tgt.ID=src.ID)
WHEN MATCHED THEN UPDATE SET tgt.NAME = src.NAME, tgt.COURSE_ID = src.CID, tgt.ACTIVE = src.ACTIVE, tgt.SKILL_ID = src.SID
WHEN NOT MATCHED THEN INSERT(ID,NAME,COURSE_ID,ACTIVE,SKILL_ID) VALUES(src.ID,src.NAME,src.CID,src.ACTIVE,src.SID);
MERGE INTO TOPICS tgt USING (SELECT  5 AS ID, 'Listas Enlazadas'         AS NAME, 2 AS CID, 1 AS ACTIVE, 2 AS SID FROM DUAL) src ON (tgt.ID=src.ID)
WHEN MATCHED THEN UPDATE SET tgt.NAME = src.NAME, tgt.COURSE_ID = src.CID, tgt.ACTIVE = src.ACTIVE, tgt.SKILL_ID = src.SID
WHEN NOT MATCHED THEN INSERT(ID,NAME,COURSE_ID,ACTIVE,SKILL_ID) VALUES(src.ID,src.NAME,src.CID,src.ACTIVE,src.SID);
MERGE INTO TOPICS tgt USING (SELECT  6 AS ID, 'Grafos'                   AS NAME, 2 AS CID, 1 AS ACTIVE, 2 AS SID FROM DUAL) src ON (tgt.ID=src.ID)
WHEN MATCHED THEN UPDATE SET tgt.NAME = src.NAME, tgt.COURSE_ID = src.CID, tgt.ACTIVE = src.ACTIVE, tgt.SKILL_ID = src.SID
WHEN NOT MATCHED THEN INSERT(ID,NAME,COURSE_ID,ACTIVE,SKILL_ID) VALUES(src.ID,src.NAME,src.CID,src.ACTIVE,src.SID);
MERGE INTO TOPICS tgt USING (SELECT  7 AS ID, 'Tablas Hash'              AS NAME, 2 AS CID, 1 AS ACTIVE, 2 AS SID FROM DUAL) src ON (tgt.ID=src.ID)
WHEN MATCHED THEN UPDATE SET tgt.NAME = src.NAME, tgt.COURSE_ID = src.CID, tgt.ACTIVE = src.ACTIVE, tgt.SKILL_ID = src.SID
WHEN NOT MATCHED THEN INSERT(ID,NAME,COURSE_ID,ACTIVE,SKILL_ID) VALUES(src.ID,src.NAME,src.CID,src.ACTIVE,src.SID);
MERGE INTO TOPICS tgt USING (SELECT  8 AS ID, 'Modelo Relacional'        AS NAME, 3 AS CID, 1 AS ACTIVE, 3 AS SID FROM DUAL) src ON (tgt.ID=src.ID)
WHEN MATCHED THEN UPDATE SET tgt.NAME = src.NAME, tgt.COURSE_ID = src.CID, tgt.ACTIVE = src.ACTIVE, tgt.SKILL_ID = src.SID
WHEN NOT MATCHED THEN INSERT(ID,NAME,COURSE_ID,ACTIVE,SKILL_ID) VALUES(src.ID,src.NAME,src.CID,src.ACTIVE,src.SID);
MERGE INTO TOPICS tgt USING (SELECT  9 AS ID, 'SQL Avanzado'             AS NAME, 3 AS CID, 1 AS ACTIVE, 3 AS SID FROM DUAL) src ON (tgt.ID=src.ID)
WHEN MATCHED THEN UPDATE SET tgt.NAME = src.NAME, tgt.COURSE_ID = src.CID, tgt.ACTIVE = src.ACTIVE, tgt.SKILL_ID = src.SID
WHEN NOT MATCHED THEN INSERT(ID,NAME,COURSE_ID,ACTIVE,SKILL_ID) VALUES(src.ID,src.NAME,src.CID,src.ACTIVE,src.SID);
MERGE INTO TOPICS tgt USING (SELECT 10 AS ID, 'Normalización'            AS NAME, 3 AS CID, 1 AS ACTIVE, 3 AS SID FROM DUAL) src ON (tgt.ID=src.ID)
WHEN MATCHED THEN UPDATE SET tgt.NAME = src.NAME, tgt.COURSE_ID = src.CID, tgt.ACTIVE = src.ACTIVE, tgt.SKILL_ID = src.SID
WHEN NOT MATCHED THEN INSERT(ID,NAME,COURSE_ID,ACTIVE,SKILL_ID) VALUES(src.ID,src.NAME,src.CID,src.ACTIVE,src.SID);
MERGE INTO TOPICS tgt USING (SELECT 11 AS ID, 'PL/SQL'                   AS NAME, 3 AS CID, 1 AS ACTIVE, 3 AS SID FROM DUAL) src ON (tgt.ID=src.ID)
WHEN MATCHED THEN UPDATE SET tgt.NAME = src.NAME, tgt.COURSE_ID = src.CID, tgt.ACTIVE = src.ACTIVE, tgt.SKILL_ID = src.SID
WHEN NOT MATCHED THEN INSERT(ID,NAME,COURSE_ID,ACTIVE,SKILL_ID) VALUES(src.ID,src.NAME,src.CID,src.ACTIVE,src.SID);
MERGE INTO TOPICS tgt USING (SELECT 12 AS ID, 'Machine Learning'         AS NAME, 4 AS CID, 1 AS ACTIVE, 4 AS SID FROM DUAL) src ON (tgt.ID=src.ID)
WHEN MATCHED THEN UPDATE SET tgt.NAME = src.NAME, tgt.COURSE_ID = src.CID, tgt.ACTIVE = src.ACTIVE, tgt.SKILL_ID = src.SID
WHEN NOT MATCHED THEN INSERT(ID,NAME,COURSE_ID,ACTIVE,SKILL_ID) VALUES(src.ID,src.NAME,src.CID,src.ACTIVE,src.SID);
MERGE INTO TOPICS tgt USING (SELECT 13 AS ID, 'Redes Neuronales'         AS NAME, 4 AS CID, 1 AS ACTIVE, 4 AS SID FROM DUAL) src ON (tgt.ID=src.ID)
WHEN MATCHED THEN UPDATE SET tgt.NAME = src.NAME, tgt.COURSE_ID = src.CID, tgt.ACTIVE = src.ACTIVE, tgt.SKILL_ID = src.SID
WHEN NOT MATCHED THEN INSERT(ID,NAME,COURSE_ID,ACTIVE,SKILL_ID) VALUES(src.ID,src.NAME,src.CID,src.ACTIVE,src.SID);
MERGE INTO TOPICS tgt USING (SELECT 14 AS ID, 'NLP'                      AS NAME, 4 AS CID, 1 AS ACTIVE, 4 AS SID FROM DUAL) src ON (tgt.ID=src.ID)
WHEN MATCHED THEN UPDATE SET tgt.NAME = src.NAME, tgt.COURSE_ID = src.CID, tgt.ACTIVE = src.ACTIVE, tgt.SKILL_ID = src.SID
WHEN NOT MATCHED THEN INSERT(ID,NAME,COURSE_ID,ACTIVE,SKILL_ID) VALUES(src.ID,src.NAME,src.CID,src.ACTIVE,src.SID);
MERGE INTO TOPICS tgt USING (SELECT 15 AS ID, 'Protocolos TCP/IP'        AS NAME, 5 AS CID, 1 AS ACTIVE, 5 AS SID FROM DUAL) src ON (tgt.ID=src.ID)
WHEN MATCHED THEN UPDATE SET tgt.NAME = src.NAME, tgt.COURSE_ID = src.CID, tgt.ACTIVE = src.ACTIVE, tgt.SKILL_ID = src.SID
WHEN NOT MATCHED THEN INSERT(ID,NAME,COURSE_ID,ACTIVE,SKILL_ID) VALUES(src.ID,src.NAME,src.CID,src.ACTIVE,src.SID);
MERGE INTO TOPICS tgt USING (SELECT 16 AS ID, 'Seguridad en Redes'       AS NAME, 5 AS CID, 0 AS ACTIVE, 5 AS SID FROM DUAL) src ON (tgt.ID=src.ID)
WHEN MATCHED THEN UPDATE SET tgt.NAME = src.NAME, tgt.COURSE_ID = src.CID, tgt.ACTIVE = src.ACTIVE, tgt.SKILL_ID = src.SID
WHEN NOT MATCHED THEN INSERT(ID,NAME,COURSE_ID,ACTIVE,SKILL_ID) VALUES(src.ID,src.NAME,src.CID,src.ACTIVE,src.SID);
MERGE INTO TOPICS tgt USING (SELECT 17 AS ID, 'Patrones de Diseño'       AS NAME, 6 AS CID, 1 AS ACTIVE, 6 AS SID FROM DUAL) src ON (tgt.ID=src.ID)
WHEN MATCHED THEN UPDATE SET tgt.NAME = src.NAME, tgt.COURSE_ID = src.CID, tgt.ACTIVE = src.ACTIVE, tgt.SKILL_ID = src.SID
WHEN NOT MATCHED THEN INSERT(ID,NAME,COURSE_ID,ACTIVE,SKILL_ID) VALUES(src.ID,src.NAME,src.CID,src.ACTIVE,src.SID);
MERGE INTO TOPICS tgt USING (SELECT 18 AS ID, 'Metodologías Ágiles'      AS NAME, 6 AS CID, 1 AS ACTIVE, 6 AS SID FROM DUAL) src ON (tgt.ID=src.ID)
WHEN MATCHED THEN UPDATE SET tgt.NAME = src.NAME, tgt.COURSE_ID = src.CID, tgt.ACTIVE = src.ACTIVE, tgt.SKILL_ID = src.SID
WHEN NOT MATCHED THEN INSERT(ID,NAME,COURSE_ID,ACTIVE,SKILL_ID) VALUES(src.ID,src.NAME,src.CID,src.ACTIVE,src.SID);
MERGE INTO TOPICS tgt USING (SELECT 19 AS ID, 'Testing y QA'             AS NAME, 6 AS CID, 1 AS ACTIVE, 6 AS SID FROM DUAL) src ON (tgt.ID=src.ID)
WHEN MATCHED THEN UPDATE SET tgt.NAME = src.NAME, tgt.COURSE_ID = src.CID, tgt.ACTIVE = src.ACTIVE, tgt.SKILL_ID = src.SID
WHEN NOT MATCHED THEN INSERT(ID,NAME,COURSE_ID,ACTIVE,SKILL_ID) VALUES(src.ID,src.NAME,src.CID,src.ACTIVE,src.SID);
MERGE INTO TOPICS tgt USING (SELECT 20 AS ID, 'React y Frameworks JS'    AS NAME, 1 AS CID, 1 AS ACTIVE, 1 AS SID FROM DUAL) src ON (tgt.ID=src.ID)
WHEN MATCHED THEN UPDATE SET tgt.NAME = src.NAME, tgt.COURSE_ID = src.CID, tgt.ACTIVE = src.ACTIVE, tgt.SKILL_ID = src.SID
WHEN NOT MATCHED THEN INSERT(ID,NAME,COURSE_ID,ACTIVE,SKILL_ID) VALUES(src.ID,src.NAME,src.CID,src.ACTIVE,src.SID);

-- =====================  LEARNING PATHS  =====================

MERGE INTO LEARNING_PATHS tgt USING (SELECT  1 AS ID, 'A00835001' AS STUDENT_ID,  1 AS TOPIC_ID FROM DUAL) src ON (tgt.ID = src.ID)
WHEN MATCHED THEN UPDATE SET tgt.STUDENT_ID = src.STUDENT_ID, tgt.TOPIC_ID = src.TOPIC_ID
WHEN NOT MATCHED THEN INSERT (ID, STUDENT_ID, TOPIC_ID) VALUES (src.ID, src.STUDENT_ID, src.TOPIC_ID);
MERGE INTO LEARNING_PATHS tgt USING (SELECT  2 AS ID, 'A00835001' AS STUDENT_ID,  2 AS TOPIC_ID FROM DUAL) src ON (tgt.ID = src.ID)
WHEN MATCHED THEN UPDATE SET tgt.STUDENT_ID = src.STUDENT_ID, tgt.TOPIC_ID = src.TOPIC_ID
WHEN NOT MATCHED THEN INSERT (ID, STUDENT_ID, TOPIC_ID) VALUES (src.ID, src.STUDENT_ID, src.TOPIC_ID);
MERGE INTO LEARNING_PATHS tgt USING (SELECT  3 AS ID, 'A00835002' AS STUDENT_ID,  3 AS TOPIC_ID FROM DUAL) src ON (tgt.ID = src.ID)
WHEN MATCHED THEN UPDATE SET tgt.STUDENT_ID = src.STUDENT_ID, tgt.TOPIC_ID = src.TOPIC_ID
WHEN NOT MATCHED THEN INSERT (ID, STUDENT_ID, TOPIC_ID) VALUES (src.ID, src.STUDENT_ID, src.TOPIC_ID);
MERGE INTO LEARNING_PATHS tgt USING (SELECT  4 AS ID, 'A00835003' AS STUDENT_ID,  4 AS TOPIC_ID FROM DUAL) src ON (tgt.ID = src.ID)
WHEN MATCHED THEN UPDATE SET tgt.STUDENT_ID = src.STUDENT_ID, tgt.TOPIC_ID = src.TOPIC_ID
WHEN NOT MATCHED THEN INSERT (ID, STUDENT_ID, TOPIC_ID) VALUES (src.ID, src.STUDENT_ID, src.TOPIC_ID);
MERGE INTO LEARNING_PATHS tgt USING (SELECT  5 AS ID, 'A00835004' AS STUDENT_ID,  5 AS TOPIC_ID FROM DUAL) src ON (tgt.ID = src.ID)
WHEN MATCHED THEN UPDATE SET tgt.STUDENT_ID = src.STUDENT_ID, tgt.TOPIC_ID = src.TOPIC_ID
WHEN NOT MATCHED THEN INSERT (ID, STUDENT_ID, TOPIC_ID) VALUES (src.ID, src.STUDENT_ID, src.TOPIC_ID);
MERGE INTO LEARNING_PATHS tgt USING (SELECT  6 AS ID, 'A00835005' AS STUDENT_ID, 15 AS TOPIC_ID FROM DUAL) src ON (tgt.ID = src.ID)
WHEN MATCHED THEN UPDATE SET tgt.STUDENT_ID = src.STUDENT_ID, tgt.TOPIC_ID = src.TOPIC_ID
WHEN NOT MATCHED THEN INSERT (ID, STUDENT_ID, TOPIC_ID) VALUES (src.ID, src.STUDENT_ID, src.TOPIC_ID);
MERGE INTO LEARNING_PATHS tgt USING (SELECT  7 AS ID, 'A00835006' AS STUDENT_ID, 17 AS TOPIC_ID FROM DUAL) src ON (tgt.ID = src.ID)
WHEN MATCHED THEN UPDATE SET tgt.STUDENT_ID = src.STUDENT_ID, tgt.TOPIC_ID = src.TOPIC_ID
WHEN NOT MATCHED THEN INSERT (ID, STUDENT_ID, TOPIC_ID) VALUES (src.ID, src.STUDENT_ID, src.TOPIC_ID);
MERGE INTO LEARNING_PATHS tgt USING (SELECT  8 AS ID, 'A00835007' AS STUDENT_ID, 18 AS TOPIC_ID FROM DUAL) src ON (tgt.ID = src.ID)
WHEN MATCHED THEN UPDATE SET tgt.STUDENT_ID = src.STUDENT_ID, tgt.TOPIC_ID = src.TOPIC_ID
WHEN NOT MATCHED THEN INSERT (ID, STUDENT_ID, TOPIC_ID) VALUES (src.ID, src.STUDENT_ID, src.TOPIC_ID);
MERGE INTO LEARNING_PATHS tgt USING (SELECT  9 AS ID, 'A00835008' AS STUDENT_ID, 19 AS TOPIC_ID FROM DUAL) src ON (tgt.ID = src.ID)
WHEN MATCHED THEN UPDATE SET tgt.STUDENT_ID = src.STUDENT_ID, tgt.TOPIC_ID = src.TOPIC_ID
WHEN NOT MATCHED THEN INSERT (ID, STUDENT_ID, TOPIC_ID) VALUES (src.ID, src.STUDENT_ID, src.TOPIC_ID);
MERGE INTO LEARNING_PATHS tgt USING (SELECT 10 AS ID, 'A00835009' AS STUDENT_ID, 20 AS TOPIC_ID FROM DUAL) src ON (tgt.ID = src.ID)
WHEN MATCHED THEN UPDATE SET tgt.STUDENT_ID = src.STUDENT_ID, tgt.TOPIC_ID = src.TOPIC_ID
WHEN NOT MATCHED THEN INSERT (ID, STUDENT_ID, TOPIC_ID) VALUES (src.ID, src.STUDENT_ID, src.TOPIC_ID);
